...
5. **Module Sources**
   ...
   - External module sources (outside this monorepo) must use pinned version constraints (exact version)
   - In-monorepo module sources may use fuzzy version constraints for minor and patch updates
