...
All Terraform modules in this repository must include comprehensive functional tests using the [Terraform Terratest Framework](https://github.com/matthew-dresden/terraform-terratest-framework).

## Testing Framework

The Terraform Terratest Framework is a Go-based testing framework specifically designed for testing Terraform modules. It provides:
