...
violation[result] if {
	...
	count(content) > 0
	not contains(content, "github.com/matthew-dresden/terraform-terratest-framework")
	...
	result := {
		...
		"resolution": "Import the framework using 'github.com/matthew-dresden/terraform-terratest-framework/pkg/testctx'",
	}
}
...
violation[result] if {
	...
	result := {
		...
		"resolution": "Add 'github.com/matthew-dresden/terraform-terratest-framework' to the go.mod file",
	}
}
